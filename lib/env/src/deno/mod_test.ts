...
Deno.test("env::deno env.iterator", () => {
...
Deno.test("env::deno env.path.prepend", () => {
...
Deno.test("env::deno env.path.remove", () => {
...
Deno.test("env::deno env.path.replace", () => {
...
Deno.test("env::deno env.path.split", () => {
...
Deno.test("env::deno env.path.iterator", () => {
...
Deno.test("env::deno env.joinPath", () => {
...
Deno.test("env::deno env.getBool", () => {
    env.set("TEST_BOOL", "1");
...
Deno.test("env::deno env.getNumber", () => {
...
Deno.test("env::deno env.getArray", () => {
...
Deno.test("env::deno env.getDate", () => {
...
Deno.test("env::deno env.getJson", () => {
...
Deno.test("env::deno env.getBinary", () => {
