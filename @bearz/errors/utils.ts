...
/**
 * Wraps an error with additional properties.
 * @param error The error to wrap.
 * @param properties The additional properties to add to the error.
 * @returns The error with the additional properties.
 */
export function mixin<T extends Record<string | symbol, unknown>>(
    error: Error,
    properties: T,
): Error & T {
    return Object.assign(error, properties) as Error & T;
}
 ...
 * @example
 * ```ts
 * import { walk } from "@bearz/errors/utils";
 *
