...
import {
    createCipheriv,
    generateKeyPair as generateKeyPair_,
    generateKeyPairSync as generateKeyPairSync_,
    getCurves,
    randomBytes,
} from "node:crypto";
import { Ber } from "asn1";
import { pbkdf as bcrypt_pbkdf } from "bcrypt-pbkdf";
import { CIPHER_INFO } from "./protocol/crypto.js";
...
export function generateKeyPair(keyType, opts, cb) {
...
export function generateKeyPairSync(keyType, opts) {
    const args = makeArgs(keyType, opts);
