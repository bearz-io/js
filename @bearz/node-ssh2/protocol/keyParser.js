...
import { CIPHER_INFO } from "./crypto.js";
import { eddsaSupported, SUPPORTED_CIPHER } from "./constants.js";
import { bufferSlice, makeBufferParser, readString, readUInt32BE, writeUInt32BE } from "./utils.js";
// end imports
    ...
    */
        ...
        for (i = 0; i < nkeys; ++i) {
          ...
          */
            ...
            keys.push(
                new OpenSSH_Private(type, privComment, privPEM, pubPEM, pubSSH, algo, decrypted),
            );
        }
        let cnt = 0;
...
export function parseDERKey(data, type) {
...
export { isParsedKey, isSupportedKeyType, parseKey };
