...
import { bindingAvailable, CIPHER_INFO, MAC_INFO } from "./crypto.js";
"use strict";

let cpuInfo;
/*
no cpu-features module
try {
...
export const DISCONNECT_REASON_BY_VALUE = Array.from(Object.entries(DISCONNECT_REASON))
