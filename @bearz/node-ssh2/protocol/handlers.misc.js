...
import { bufferParser, bufferSlice, doFatalError, sigSSHToASN1, writeUInt32BE } from "./utils.js";
import { CHANNEL_OPEN_FAILURE, COMPAT, MESSAGE, TERMINAL_MODE } from "./constants.js";

import { parseKey } from "./keyParser.js";

"use strict";

const TERMINAL_MODE_BY_VALUE = Array.from(Object.entries(TERMINAL_MODE))
