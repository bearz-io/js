...
export class BunScriptCommand extends ShellCommand {
    ...
    /**
     * Gets the file extension associated with bun scripts.
     */
    ...
    /**
     * Gets the bun arguments for executing the javascript.
     * @param script The javascript to execute.
 ...
 * import { bun } from "@spawn/bun";
 *
 * /// execute the bun command and writes the version to stdout.
 ...
 *
 * @param script - The bun script to execute.
 * @param options - Optional options for the bun shell command.
