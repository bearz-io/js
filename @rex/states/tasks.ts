 ...
 */
export function registerStateStore(def: RegisterStateStoreTaskDef, map?: TaskMap): RegisterStateStoreTaskBuilder;
/**
 * 
...
tasksRegistry.set(registerStateDriverId, {
    ...
    inputs: [{
        name: "name",
        type: "string",
        description: "The name of the state driver. This is used to reference the driver in other tasks.",
        required: true,
    }, {
        name: "use",
        type: "string",
